        ...
        <form action="{{ route('store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-info">
                <div class="form-item box1">
                    <input class='form-control mon-input' type="text" name="nom" id="nom" placeholder='nom' />
                </div>
                <div class="form-item box2">
                    <input class='form-control mon-input' type="text" name="prenom" id="prenom" placeholder='prenom' />
                </div>
                <div class="form-item box3">
                    <input class='form-control mon-input' type="text" name="phone" id="phone" placeholder='telephone' />
                </div>
                <div class="form-item box4">
                    <input class='form-control mon-input' type="text" name="mail" id="mail" placeholder='e-mail' />
                </div>
                <div class="form-item box7">
                    <select class='form-control' name="mention" id="">
                ...
                <div class="form-item box6">
                    <input class='form-control mon-input' type="number" name="cin" id="cin" placeholder='numero CIN' />
                </div>
                <div class="form-item box7">
                ...
                <div class="form-item">
                    ...
                    <input type="file" placeholder="photo profile" name="profilepic" id="profilepic" accept="image/png , image/jpg , image/jpeg">
                </div>
            </div>
            <div class="form-title">
            ...
            <div class="form-info">
                ...
                <div class="form-item box9">
                    <input class='form-control mon-input' type="number" name="bordereau" id="bordereau" placeholder='numero bordereau' />
                </div>
                <div class="form-item box10"  >
                    <input class='form-control mon-input' type="number" name="montant" id="montant" placeholder='montant a payer' />
                </div>
            </div>
            <div class="form-envoie">
                <button class='btn btn-primary mon-boutton' type="submit">VALIDER L'INSCRIPTION</button>
            </div>
        </form>
    </div>
    <div class='footer'>
